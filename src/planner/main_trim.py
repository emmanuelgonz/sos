...
class Environment(Observer):
    ...
    *The Environment object class inherits properties from the Observer object class in the NOS-T tools library*
    ...
    def get_session_token(self, session, mfa_serial=None, mfa_token=None, mfa_required=True):
    ...
    def interpolate_dataset(self, dataset, variables_to_interpolate, lat_coords, lon_coords, time_coords):
    ...
    #     gdf = gpd.read_file(BytesIO(fgrab))
...
def main():
    ...
    mo_basin = get_missouri_basin(file_path="data/Downloaded_files/Mo_basin_shp/WBD_10_HU2_Shape/Shape/WBDHU2.shp") #"WBD_10_HU2_Shape/Shape/WBDHU2.shp")
    ...
    #Final ETA#
    ###########
    print('Loading all cells polygon...')
    ...
    print(selected_cells_gdf_clipped)
